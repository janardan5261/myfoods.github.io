            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="left_contact">
                    ...
                    <ul class="list catagories">
                        <li><a href="#"><i class="fa fa-home color1"></i>No 271, Red Cross Building, Modern Street,
                                Newyork City, USA.</a></li>
                        <li><a href="#"><i
                                    class="fa fa-envelope color1"></i><span>Organicstore@gmail.com</span><br>customersupport@organic.com</a>
                        </li>
                        <li><a href="#"><i class="fa fa-phone color1"></i>+91 (321) 758 142 5698
                                <br>1800-8692-258-1547</a></li>
                    </ul>

                    <div class="border-area">
                        <h6>Woriking Hours</h6>
                        <div class="list Business">
                            <p>Monday - Friday: 09.00am to 07.00pm <br>Saturday: 10.00am to 05.00pm <br>Sunday:
                                <span>Closed</span></p>
                        </div>
