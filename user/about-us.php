...
<!-- Mirrored from st.ourhtmldemo.com/template/organic_store/about-us.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Aug 2023 13:27:51 GMT -->
<head>
		<meta charset="UTF-8">
		<!-- For IE -->
				...
				<div class="container">
					<nav class="menuzord pull-left" id="main_menu">
					   <ul class="menuzord-menu">
					      ...
					      <li class="current_page"><a href="about-us.php">About us</a></li>
					      <li><a href="#">store</a>
					      	<ul class="dropdown">
					            <li><a href="shop.php">Shop With Sidebar</a></li>
					            <li><a href="shop-single.php">Product Detail</a></li>
					      ...
					      <li><a href="#">News</a>
					      	<ul class="dropdown">
					            ...
					            <li><a href="blog-list-sidebar.php">News With Sidebar</a></li>
					            <li><a href="blog-grid.php">News Masonary</a></li>
					            <li><a href="blog-details.php">News Single</a></li>
					         </ul>
					      </li>
					      <li><a href="#">gallery</a>
					      	<ul class="dropdown">
					            <li><a href="gallery-grid.php">Gallery Grid</a></li>
                                <li><a href="gallery-masonry.php">Gallery Masonary</a></li>
					      ...
					      <li><a href="#">Pages</a>
					      	<ul class="dropdown">
					            ...
					            <li><a href="404.php">404v page</a></li>
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-12">
							<div class="about-text">
								...
								<div class="text"><p>How all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness</p></div>
								<div class="icon-box">
					...
					<div class="row">
						<div class="col-md-4 col-sm-12 col-xs-12 color1_bg text-center">
							<div class="single-item ">
								...
								<div class="icon"><i class="icon-chicken"></i></div>
								<p>
						...
						<div class="col-md-4 col-sm-12 col-xs-12 color1_bg text-center">
							<div class="single-item ">
								...
								<div class="icon"><i class="icon-nature"></i></div>
								<p>
								We will give you a complete account of the system, and expound the actual <br>teachings of the great explorer of the truth, the master-builder of <br> human complete happiness.</p>
								<div class="link"><a href="#">Shop Now</a></div>
							</div>
			...
			<section class="four-column">
				<div class="container text-center">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-12 text-center">
							<div class="single-item ">
								<div class="inner-box"><div class="icon"><i class="rot icon-nature-1"></i><span>1</span></div></div>
								<h5>Packing</h5>
								<p>
								<p>
								Organicstore.com’s customers order is <br>captured by warehouse API..
						...
						<div class="col-md-3 col-sm-6 col-xs-12 text-center">
							<div class="single-item ">
								<div class="inner-box"><div class="icon"><i class="rot icon-transport"></i><span>1</span></div></div>
								<h5>Delivery</h5>
								<p>
								Organicstore.com’s customers order is <br>captured by warehouse API..
								</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-12 text-center">
							<div class="single-item ">
								<div class="inner-box"><div class="icon"><i class="rot icon-check"></i><span>1</span></div></div>
								<h5>Reporting</h5>
								<p>
								Organicstore.com’s customers order is <br>captured by warehouse API..
								</p>
					...
					<div class="link"><a href="#" class="rot tran3s color1_bg">Shop products</a></div>
				</div>
			</section>
			...
			<section class="gallery gallery-grid about-gallery" style="background-image:url(images/background/3.jpg);">
			    <div class="tab-links">
			        <div class="container">
			            ...
			            <ul class="tab-list">
			                <li><a href="#Vegetables" class="tab-btn active"><h2><i class="icon-food-2"></i>Vegetables</h2></a></li>
			                <li><a href="#Fruits" class="tab-btn"><h2><i class="icon-fruit"></i>Fruits & Drinks</h2></a></li>
			                <li><a href="#Fresh" class="tab-btn"><h2><i class="icon-food-1"></i>Fresh Meat</h2></a></li>
			                <li><a href="#Beauty" class="tab-btn"><h2><i class="icon-cream"></i>Beauty Care</h2></a></li>
			            </ul>
			            <div class="link-btn"><a href="#" class="tran3s">VIEW MORE<span class="fa fa-sort-desc"></span></a></div>
			        </div>
			    </div>
			                    <!--tab Content-->
			    <div class="tab-content">
			        ...
			        <div class="container-fluid">
			            ...
			            <div class="item collapsed" id="Vegetables">
			                <div class="row-10">
					                        	...
					                        	<div class="inner">
						                        	<div class="image-view">
						                                <div class="icon-holder">
						                                    <a href="images/gallery/30.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
						                                </div>
						                            </div>
						                        	<div class="bottom-content">
						                        		<h4><a href="#">Coffee Break Cake</a></h4>
						                        		<div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
						                        		<div class="icon-box"><a href="shop-cart.php"><span class="icon-icon-32846"></span></a></div>
						                        	</div>
					                        	</div>
					                        </div>
						                </div>
					                    ...
					                    <div class="single-item center">
					                        ...
					                        <div class="overlay-box">
					                        	<div class="inner">
						                        	<div class="image-view">
						                                <div class="icon-holder">
						                                    <a href="images/gallery/31.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
						                                </div>
						                            </div>
						                        	<div class="bottom-content">
						                        		<h4><a href="#">Coffee Break Cake</a></h4>
					                    ...
					                    <div class="single-item center">
					                        ...
					                        <div class="overlay-box">
					                        	<div class="inner">
						                        	<div class="image-view">
						                                <div class="icon-holder">
						                                    <a href="images/gallery/32.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
						                                </div>
						                            </div>
						                        	<div class="bottom-content">
						                        		<h4><a href="#">Coffee Break Cake</a></h4>
					                    ...
					                    <div class="single-item center">
					                        ...
					                        <div class="overlay-box">
					                        	<div class="inner">
						                        	<div class="image-view">
						                                <div class="icon-holder">
						                                    <a href="images/gallery/33.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
						                                </div>
						                            </div>
						                        	<div class="bottom-content">
						                        		<h4><a href="#">Coffee Break Cake</a></h4>
					                    ...
					                    <div class="single-item center">
					                        ...
					                        <div class="overlay-box">
					                        	<div class="inner">
						                        	<div class="image-view">
						                                <div class="icon-holder">
						                                    <a href="images/gallery/34.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
						                                </div>
						                            </div>
						                        	<div class="bottom-content">
						                        		<h4><a href="#">Coffee Break Cake</a></h4>
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<div class="award-logo">
								<ul>
									<li><img src="images/partner-logo/5.png" alt=""></li>
									<li><img src="images/partner-logo/6.png" alt=""></li>
									<li><img src="images/partner-logo/7.png" alt=""></li>
									<li><img src="images/partner-logo/8.png" alt=""></li>
								</ul>
							</div>
							<div class="customer-text">
								<p><b>Customer Support:</b>  If you have any doubt about ConsultPress WordPress or how we can support your business, Send us an <span>email</span> and we’ll get in touch shortly, or Contact via <span>Support Forum.</span></p>
								<p><b>Office Hours :</b> 07:30 and 19:00 Monday to Saturday,<span>Sunday - Holiday</span></p>
							</div>
						</div>
						<div class="col-md-6 col-sm-12">
							<div class="contact_in-box">
				                ...
				                <form action="https://st.ourhtmldemo.com/template/organic_store/inc/sendmail.php">
				                	<div class="row">
					                    <div class="col-md-6">
			    ...
			    <div class="container">
			        ...
			        <div class="float_right">
			        	<div class="contact-box">
		                    ...
		                    <form method="post" action="https://st.ourhtmldemo.com/template/organic_store/sendemail.php" class="contact-form" novalidate="novalidate">
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 footer_logo">
								<a href="index.php"><img src="images/logo/logo-2.png" alt="Logo"></a>
...
<!-- Mirrored from st.ourhtmldemo.com/template/organic_store/about-us.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Aug 2023 13:28:04 GMT -->
</html>