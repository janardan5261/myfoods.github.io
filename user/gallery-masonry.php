...
<!-- Mirrored from st.ourhtmldemo.com/template/organic_store/gallery-masonry.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Aug 2023 13:28:24 GMT -->
<head>
		<meta charset="UTF-8">
		<!-- For IE -->
				...
				<div class="container">
					<nav class="menuzord pull-left" id="main_menu">
					   <ul class="menuzord-menu">
					      ...
					      <li class="current_page"><a href="#">gallery</a>
					      	<ul class="dropdown">
		        	...
		        	<div class="sortable-masonry">
		        		<div class="filters text-center">
			                <ul class="filter-tabs filter-btns clearfix">
			                    <li class="filter active" data-role="button" data-filter=".isotop_item"><span class="txt">vew All</span></li>
			                    <li class="filter" data-role="button" data-filter=".fruits"><span class="txt">Fruits & Drinks</span></li>
			                    <li class="filter" data-role="button" data-filter=".vegetables"><span class="txt">vegetables</span></li>
			                    <li class="filter" data-role="button" data-filter=".FreshMeat"><span class="txt">FreshMeat</span></li>
			                    <li class="filter" data-role="button" data-filter=".Healthy"><span class="txt">Healthy</span></li>
			            ...
			            <div class="row items-container clearfix">
				            ...
				            <div class="col-md-3 col-sm-6 col-xs-12  default-item isotop_item FreshMeat Healthy Beauty" style="display: inline-block;">
				                <div class="inner-box">
				                        	...
				                        	<div class="inner">
					                        	<div class="image-view">
					                                <div class="icon-holder">
					                                    <a href="images/gallery/18.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
					                                </div>
					                            </div>
				            ...
				            <div class="col-md-3 col-sm-6 col-xs-12  default-item isotop_item Beauty" style="display: inline-block;">
				                <div class="inner-box">
				                    <div class="single-item center">
				                        ...
				                        <div class="overlay-box">
				                        	<div class="inner">
					                        	<div class="image-view">
					                                <div class="icon-holder">
					                                    <a href="images/gallery/27.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
					                                </div>
					                            </div>
					                        	<div class="bottom-content">
					                        		<h4><a href="#">Coffee Break Cake</a></h4>
				            ...
				            <div class="col-md-3 col-sm-6 col-xs-12  default-item isotop_item fruits vegetables FreshMeat" style="display: inline-block;">
				                <div class="inner-box">
				                    <div class="single-item center">
				                        ...
				                        <div class="overlay-box">
				                        	<div class="inner">
					                        	<div class="image-view">
					                                <div class="icon-holder">
					                                    <a href="images/gallery/19.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
					                                </div>
					                            </div>
					                        	<div class="bottom-content">
					                        		<h4><a href="#">Coffee Break Cake</a></h4>
				                    ...
				                    <div class="single-item center">
				                        ...
				                        <div class="overlay-box">
				                        	<div class="inner">
					                        	<div class="image-view">
					                                <div class="icon-holder">
					                                    <a href="images/gallery/20.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
					                                </div>
					                            </div>
					                        	<div class="bottom-content">
					                        		<h4><a href="#">Coffee Break Cake</a></h4>
				            ...
				            <div class="col-md-3 col-sm-6 col-xs-12  default-item isotop_item fruits Beauty" style="display: inline-block;">
				                <div class="inner-box">
				                    <div class="single-item center">
				                        ...
				                        <div class="overlay-box">
				                        	<div class="inner">
					                        	<div class="image-view">
					                                <div class="icon-holder">
					                                    <a href="images/gallery/21.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
					                                </div>
					                            </div>
					                        	<div class="bottom-content">
					                        		<h4><a href="#">Coffee Break Cake</a></h4>
				            ...
				            <div class="col-md-3 col-sm-6 col-xs-12  default-item isotop_item fruits vegetables FreshMeat Healthy Beauty" style="display: inline-block;">
				                <div class="inner-box">
				                    <div class="single-item center">
				                        ...
				                        <div class="overlay-box">
				                        	<div class="inner">
					                        	<div class="image-view">
					                                <div class="icon-holder">
					                                    <a href="images/gallery/22.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
					                                </div>
					                            </div>
					                        	<div class="bottom-content">
					                        		<h4><a href="#">Coffee Break Cake</a></h4>
				                    ...
				                    <div class="single-item center">
				                        ...
				                        <div class="overlay-box">
				                        	<div class="inner">
					                        	<div class="image-view">
					                                <div class="icon-holder">
					                                    <a href="images/gallery/23.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
					                                </div>
					                            </div>
					                        	<div class="bottom-content">
					                        		<h4><a href="#">Coffee Break Cake</a></h4>
				                    ...
				                    <div class="single-item center">
				                        ...
				                        <div class="overlay-box">
				                        	<div class="inner">
					                        	<div class="image-view">
					                                <div class="icon-holder">
					                                    <a href="images/gallery/24.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
					                                </div>
					                            </div>
					                        	<div class="bottom-content">
					                        		<h4><a href="#">Coffee Break Cake</a></h4>
				            ...
				            <div class="col-md-3 col-sm-6 col-xs-12  default-item isotop_item fruits vegetables Healthy Beauty" style="display: inline-block;">
				                <div class="inner-box">
				                    <div class="single-item center">
				                        ...
				                        <div class="overlay-box">
				                        	<div class="inner">
					                        	<div class="image-view">
					                                <div class="icon-holder">
					                                    <a href="images/gallery/25.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
					                                </div>
					                            </div>
					                        	<div class="bottom-content">
					                        		<h4><a href="#">Coffee Break Cake</a></h4>
				                    ...
				                    <div class="single-item center">
				                        ...
				                        <div class="overlay-box">
				                        	<div class="inner">
					                        	<div class="image-view">
					                                <div class="icon-holder">
					                                    <a href="images/gallery/26.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
					                                </div>
					                            </div>
					                        	<div class="bottom-content">
					                        		<h4><a href="#">Coffee Break Cake</a></h4>
				            ...
				            <div class="col-md-3 col-sm-6 col-xs-12  default-item isotop_item fruits vegetables FreshMeat  Beauty" style="display: inline-block;">
				                <div class="inner-box">
				                    <div class="single-item center">
				                        ...
				                        <div class="overlay-box">
				                        	<div class="inner">
					                        	<div class="image-view">
					                                <div class="icon-holder">
					                                    <a href="images/gallery/28.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
					                                </div>
					                            </div>
					                        	<div class="bottom-content">
					                        		<h4><a href="#">Coffee Break Cake</a></h4>
...
<!-- Mirrored from st.ourhtmldemo.com/template/organic_store/gallery-masonry.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Aug 2023 13:28:30 GMT -->
</html>