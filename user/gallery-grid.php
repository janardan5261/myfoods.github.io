...
<!-- Mirrored from st.ourhtmldemo.com/template/organic_store/gallery-grid.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Aug 2023 13:28:17 GMT -->
<head>
		<meta charset="UTF-8">
		<!-- For IE -->
		        ...
		        <div class="container">
		            ...
		            <div class="filters text-center">
		                <ul class="filter-tabs filter-btns clearfix">
		                    <li class="filter active" data-role="button" data-filter="all"><span class="txt">vew All</span></li>
		            ...
		            <div class="row filter-list clearfix">
			            ...
			            <!--Default Item-->
			            <div class="col-md-3 col-sm-6 col-xs-12 mix mix_all default-item all FreshMeat Healthy Beauty" style="display: inline-block;">
			                <div class="inner-box">
			                        	...
			                        	<div class="inner">
				                        	<div class="image-view">
				                                <div class="icon-holder">
				                                    <a href="images/gallery/7.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
				                                </div>
				                            </div>
			            ...
			            <!--Default Item-->
			            <div class="col-md-3 col-sm-6 col-xs-12 mix mix_all default-item all Beauty" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        ...
			                        <div class="overlay-box">
			                        	<div class="inner">
				                        	<div class="image-view">
				                                <div class="icon-holder">
				                                    <a href="images/gallery/8.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
				                                </div>
				                            </div>
				                        	<div class="bottom-content">
				                        		<h4><a href="#">Coffee Break Cake</a></h4>
			            ...
			            <!--Default Item-->
			            <div class="col-md-3 col-sm-6 col-xs-12 mix mix_all default-item all fruits vegetables FreshMeat" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        ...
			                        <div class="overlay-box">
			                        	<div class="inner">
				                        	<div class="image-view">
				                                <div class="icon-holder">
				                                    <a href="images/gallery/13.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
				                                </div>
				                            </div>
				                        	<div class="bottom-content">
				                        		<h4><a href="#">Coffee Break Cake</a></h4>
			                    ...
			                    <div class="single-item center">
			                        ...
			                        <div class="overlay-box">
			                        	<div class="inner">
				                        	<div class="image-view">
				                                <div class="icon-holder">
				                                    <a href="images/gallery/9.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
				                                </div>
				                            </div>
				                        	<div class="bottom-content">
				                        		<h4><a href="#">Coffee Break Cake</a></h4>
			            ...
			            <!--Default Item-->
			            <div class="col-md-3 col-sm-6 col-xs-12 mix mix_all default-item all fruits Beauty" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        ...
			                        <div class="overlay-box">
			                        	<div class="inner">
				                        	<div class="image-view">
				                                <div class="icon-holder">
				                                    <a href="images/gallery/10.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
				                                </div>
				                            </div>
				                        	<div class="bottom-content">
				                        		<h4><a href="#">Coffee Break Cake</a></h4>
			            ...
			            <!--Default Item-->
			            <div class="col-md-3 col-sm-6 col-xs-12 mix mix_all default-item all fruits vegetables FreshMeat Healthy Beauty" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        ...
			                        <div class="overlay-box">
			                        	<div class="inner">
				                        	<div class="image-view">
				                                <div class="icon-holder">
				                                    <a href="images/gallery/11.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
				                                </div>
				                            </div>
				                        	<div class="bottom-content">
				                        		<h4><a href="#">Coffee Break Cake</a></h4>
			                    ...
			                    <div class="single-item center">
			                        ...
			                        <div class="overlay-box">
			                        	<div class="inner">
				                        	<div class="image-view">
				                                <div class="icon-holder">
				                                    <a href="images/gallery/12.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
				                                </div>
				                            </div>
				                        	<div class="bottom-content">
				                        		<h4><a href="#">Coffee Break Cake</a></h4>
			            ...
			            <!--Default Item-->
			            <div class="col-md-3 col-sm-6 col-xs-12 mix mix_all default-item all fruits vegetables Healthy Beauty" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        ...
			                        <div class="overlay-box">
			                        	<div class="inner">
				                        	<div class="image-view">
				                                <div class="icon-holder">
				                                    <a href="images/gallery/14.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
				                                </div>
				                            </div>
				                        	<div class="bottom-content">
				                        		<h4><a href="#">Coffee Break Cake</a></h4>
			                    ...
			                    <div class="single-item center">
			                        ...
			                        <div class="overlay-box">
			                        	<div class="inner">
				                        	<div class="image-view">
				                                <div class="icon-holder">
				                                    <a href="images/gallery/15.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
				                                </div>
				                            </div>
				                        	<div class="bottom-content">
				                        		<h4><a href="#">Coffee Break Cake</a></h4>
			                    ...
			                    <div class="single-item center">
			                        ...
			                        <div class="overlay-box">
			                        	<div class="inner">
				                        	<div class="image-view">
				                                <div class="icon-holder">
				                                    <a href="images/gallery/16.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
				                                </div>
				                            </div>
				                        	<div class="bottom-content">
				                        		<h4><a href="#">Coffee Break Cake</a></h4>
			            ...
			            <!--Default Item-->
			            <div class="col-md-3 col-sm-6 col-xs-12 mix mix_all default-item all fruits vegetables FreshMeat  Beauty" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        ...
			                        <div class="overlay-box">
			                        	<div class="inner">
				                        	<div class="image-view">
				                                <div class="icon-holder">
				                                    <a href="images/gallery/17.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
				                                </div>
				                            </div>
				                        	<div class="bottom-content">
				                        		<h4><a href="#">Coffee Break Cake</a></h4>
...
<!-- Mirrored from st.ourhtmldemo.com/template/organic_store/gallery-grid.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Aug 2023 13:28:24 GMT -->
</html>